...
@Component
public class AccountingBusinessEventConsumer extends AbstractProjectionConsumer {

    public AccountingBusinessEventConsumer(DomainEventProjectionRepository repository) {
