...
public final class ThirdParty extends BaseEntity {
    ...
    private ThirdParty(
        ...
        this.name = name == null || name.isBlank() ? this.displayName : name.trim();
        ...
        this.logoId = logoId;
        this.accountingAccountNumbers = normalizeAccountingAccountNumbers(accountingAccountNumbers, this.accountingAccount);
    ...
    public String code() { return referenceCode; }
