...
public class SalesAgentController extends CommercialThirdPartyController {

    public SalesAgentController(CreateThirdPartyUseCase createThirdPartyUseCase,
