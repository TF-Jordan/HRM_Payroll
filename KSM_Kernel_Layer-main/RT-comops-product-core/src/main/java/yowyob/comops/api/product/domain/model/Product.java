...
public final class Product extends BaseEntity {
    ...
    private Product(UUID id, UUID tenantId, Instant createdAt, Instant updatedAt, UUID organizationId, String sku,
            String name, String familyCode, String variantLabel, String barcode, String description, BigDecimal unitPrice,
    ...
    public static Product create(UUID tenantId, UUID organizationId, String sku, String name, String familyCode,
            String variantLabel, String barcode, String description, BigDecimal unitPrice, String currency, String status) {
        Instant now = Instant.now();
        return new Product(UUID.randomUUID(), tenantId, now, now, organizationId, sku, name, familyCode, variantLabel,
    ...
    public static Product rehydrate(UUID id, UUID tenantId, Instant createdAt, Instant updatedAt, UUID organizationId,
            String sku, String name, String familyCode, String variantLabel, String barcode, String description,
            BigDecimal unitPrice, String currency, String status) {
        return new Product(id, tenantId, createdAt, updatedAt, organizationId, sku, name, familyCode, variantLabel,
                barcode, description, unitPrice, currency, status);
    }

    public Product update(String sku, String name, String familyCode, String variantLabel, String barcode,
            String description, BigDecimal unitPrice, String currency, String status) {
        return new Product(id(), tenantId(), createdAt(), Instant.now(), organizationId, sku, name, familyCode,
