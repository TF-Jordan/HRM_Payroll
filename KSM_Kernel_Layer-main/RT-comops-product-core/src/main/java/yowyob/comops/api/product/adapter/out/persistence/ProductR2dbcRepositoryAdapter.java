...
public class ProductR2dbcRepositoryAdapter implements ProductRepository {
    ...
    public Mono<Product> save(Product product) {
        ProductEntity entity = new ProductEntity(product.id(), product.tenantId(), product.createdAt(), product.updatedAt(),
                product.organizationId(), product.sku(), product.name(), product.familyCode(), product.variantLabel(),
                product.barcode(), product.description(), product.unitPrice(), product.currency(), product.status());
    ...
    private Product toDomain(ProductEntity entity) {
        return Product.rehydrate(entity.id(), entity.tenantId(), entity.createdAt(), entity.updatedAt(),
                entity.organizationId(), entity.sku(), entity.name(), entity.familyCode(), entity.variantLabel(),
                entity.barcode(), entity.description(), entity.unitPrice(), entity.currency(), entity.status());
    }
}
